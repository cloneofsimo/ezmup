...
class MyModel(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_dim, head_dim, num_layers):
        ...
        self.layers = nn.ModuleList([AttentionLayer(hidden_dim, head_dim) for _ in range(num_layers)])
...
model = MyModel(input_dim = 41, output_dim = 41, hidden_dim=47 * 2, head_dim=47, num_layers=2)
model.to('cuda:0')
...
plot_coord_data(df, y='l1', save_to="example.png", suptitle=None, x='width', hue='module',)